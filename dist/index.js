...
function Dn() {
  if (mo)
    return Ke;
  mo = 1;
  var r = et, e = Symbol.for("react.element"), t = Symbol.for("react.fragment"), o = Object.prototype.hasOwnProperty, n = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, i = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(a, c, l) {
...
function jn() {
  return bo || (bo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(m, S, L) {
      {
        ...
        K !== "" && (S += "%s", L = L.concat([K]));
        var J = L.map(function(z) {
          return String(z);
        });
        J.unshift("Warning: " + S), Function.prototype.apply.call(console[m], console, J);
      }
    }
    var E = !1, x = !1, I = !1, V = !1, _ = !1, T;
    T = Symbol.for("react.module.reference");
    function O(m) {
      return !!(typeof m == "string" || typeof m == "function" || m === o || m === i || _ || m === n || m === l || m === u || V || m === k || E || x || I || typeof m == "object" && m !== null && (m.$$typeof === p || m.$$typeof === d || m.$$typeof === s || m.$$typeof === a || m.$$typeof === c || // This needs to include all possible module reference object
    ...
    function D(m) {
      ...
      if (typeof m == "object")
        switch (m.$$typeof) {
          ...
          case c:
            return H(m, m.render, "ForwardRef");
          case d:
            var P = m.displayName || null;
            return P !== null ? P : D(m.type) || "Memo";
          case p: {
            var K = m, J = K._payload, z = K._init;
            try {
              return D(z(J));
            } catch {
              return null;
    ...
    var Z = Object.assign, C = 0, B, M, A, $, j, ee, G;
    function me() {
    }
    ...
    function un() {
      {
        if (C === 0) {
          B = console.log, M = console.info, A = console.warn, $ = console.error, j = console.group, ee = console.groupCollapsed, G = console.groupEnd;
          var m = {
            configurable: !0,
            enumerable: !0,
            value: me,
    ...
    var bt = v.ReactCurrentDispatcher, vt;
    function it(m, S, L) {
      {
        if (vt === void 0)
          try {
...
` + vt + m;
    ...
    function to(m, S) {
      ...
      var J;
      J = bt.current, bt.current = null, un();
      try {
        if (S) {
          var z = function() {
            throw Error();
...
`), se = P.stack.split(`
`), te = U.length - 1, oe = se.length - 1; te >= 1 && oe >= 0 && U[te] !== se[oe]; )
            oe--;
          for (; te >= 1 && oe >= 0; te--, oe--)
            if (U[te] !== se[oe]) {
              if (te !== 1 || oe !== 1)
                do
                  if (te--, oe--, oe < 0 || U[te] !== se[oe]) {
                    var de = `
` + U[te].replace(" at new ", " at ");
                    return m.displayName && de.includes("<anonymous>") && (de = de.replace("<anonymous>", m.displayName)), typeof m == "function" && rt.set(m, de), de;
                  }
                while (te >= 1 && oe >= 0);
              break;
            }
        ...
        kt = !1, bt.current = J, pn(), Error.prepareStackTrace = K;
      }
      var Oe = m ? m.displayName || m.name : "", go = Oe ? it(Oe) : "";
      return typeof m == "function" && rt.set(m, go), go;
    }
    function gn(m, S, L) {
      return to(m, !1);
    }
    ...
    var at = Object.prototype.hasOwnProperty, oo = {}, no = v.ReactDebugCurrentFrame;
    function lt(m) {
      if (m) {
        var S = m._owner, L = st(m.type, m._source, S ? S.type : null);
        no.setExtraStackFrame(L);
      } else
        no.setExtraStackFrame(null);
    }
    function bn(m, S, L, P, K) {
      {
          ...
          if (J(m, z)) {
            ...
            try {
              if (typeof m[z] != "function") {
                var se = Error((P || "React class") + ": " + L + " type `" + z + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof m[z] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw se.name = "Invariant Violation", se;
              }
              U = m[z](S, z, P, L, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (te) {
              U = te;
            }
            U && !(U instanceof Error) && (lt(K), b("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", P || "React class", L, z, typeof U), lt(null)), U instanceof Error && !(U.message in oo) && (oo[U.message] = !0, lt(K), b("Failed %s type: %s", L, U.message), lt(null));
          }
      }
    }
    ...
    function ro(m) {
      if (yn(m))
        return b("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", kn(m)), io(m);
    }
    var Ye = v.ReactCurrentOwner, wn = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Cn(m, S) {
      if (typeof m.ref == "string" && Ye.current && S && Ye.current.stateNode !== S) {
        var L = D(Ye.current.type);
        wt[L] || (b('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', D(Ye.current.type), m.ref), wt[L] = !0);
      }
    }
    function Sn(m, S) {
      {
        var L = function() {
          so || (so = !0, b("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", S));
        };
    ...
    function Bn(m, S, L, P, K) {
      {
        var J, z = {}, U = null, se = null;
        L !== void 0 && (ro(L), U = "" + L), En(S) && (ro(S.key), U = "" + S.key), xn(S) && (se = S.ref, Cn(S, K));
        for (J in S)
          at.call(S, J) && !wn.hasOwnProperty(J) && (z[J] = S[J]);
        if (m && m.defaultProps) {
        ...
        if (U || se) {
          ...
          U && Sn(z, oe), se && Tn(z, oe);
        }
        return _n(m, U, se, K, P, Ye.current, z);
      }
    }
    var xt = v.ReactCurrentOwner, lo = v.ReactDebugCurrentFrame;
    function Me(m) {
      if (m) {
        var S = m._owner, L = st(m.type, m._source, S ? S.type : null);
        lo.setExtraStackFrame(L);
      } else
...
Check the top-level render call using <` + L + ">.");
    ...
    function uo(m, S) {
      {
        ...
        ho[L] = !0;
        var P = "";
        m && m._owner && m._owner !== xt.current && (P = " It was passed a child from " + D(m._owner.type) + "."), Me(m), b('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', L, P), Me(null);
      }
    }
    function po(m, S) {
      {
        ...
        if (yt(m))
          ...
          if (typeof K == "function" && K !== m.entries)
            for (var J = K.call(m), z; !(z = J.next()).done; )
              Ct(z.value) && uo(z.value, S);
        }
      }
    }
    function Mn(m) {
      {
        ...
        if (L) {
          var P = D(S);
          bn(L, m.props, "prop", P, m);
        } else if (S.PropTypes !== void 0 && !Et) {
          Et = !0;
          var K = D(S);
    ...
    function On(m) {
      {
        for (var S = Object.keys(m.props), L = 0; L < S.length; L++) {
          var P = S[L];
          if (P !== "children" && P !== "key") {
            Me(m), b("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", P), Me(null);
            break;
          }
        }
        m.ref !== null && (Me(m), b("Invalid attribute `ref` supplied to `React.Fragment`."), Me(null));
      }
    }
    function fo(m, S, L, P, K, J) {
      {
        var z = O(m);
        if (!z) {
          var U = "";
          ...
          se ? U += se : U += co();
          var te;
          m === null ? te = "null" : yt(m) ? te = "array" : m !== void 0 && m.$$typeof === e ? (te = "<" + (D(m.type) || "Unknown") + " />", U = " Did you accidentally export a JSX literal instead of a component?") : te = typeof m, b("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", te, U);
        }
        var oe = Bn(m, S, L, K, J);
        if (oe == null)
          return oe;
    ...
    var Nn = Rn, Pn = An;
    Xe.Fragment = o, Xe.jsx = Nn, Xe.jsxs = Pn;
  }()), Xe;
}
process.env.NODE_ENV === "production" ? Bt.exports = Dn() : Bt.exports = jn();
var q = Bt.exports, Fn = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Ut(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
function St() {
...
let Hn = (r = 21) => crypto.getRandomValues(new Uint8Array(r)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
var Mo = /* @__PURE__ */ ((r) => (r.VERBOSE = "VERBOSE", r.INFO = "INFO", r.WARN = "WARN", r.ERROR = "ERROR", r))(Mo || {});
const N = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
function nt(r, e, t = "log", o, n = "color: inherit") {
...
const X = nt.bind(window, !1), pe = nt.bind(window, !0);
function Ie(r) {
...
async function qn(r, e = () => {
  ...
  async function o(n, i, s) {
    try {
      await n.function(n.data), await i(ko(n.data) ? {} : n.data);
    } catch {
      s(ko(n.data) ? {} : n.data);
    }
  }
...
function It(r, ...e) {
  ...
  if (re(r) && re(t))
    for (const o in t)
      re(t[o]) ? (r[o] || Object.assign(r, { [o]: {} }), It(r[o], t[o])) : Object.assign(r, { [o]: t[o] });
  return It(r, ...e);
}
function ft(r) {
  const e = Yn();
...
const wo = typeof window < "u" && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function Jn(r, e) {
  const t = Array.isArray(r) || re(r), o = Array.isArray(e) || re(e);
...
let y = class ae {
  ...
  static findAllInputs(e) {
    return Ao(e.querySelectorAll(ae.allInputsSelector)).reduce((t, o) => ae.isNativeInput(o) || ae.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...ae.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static getDeepestNode(e, t = !1) {
    ...
    if (e && e.nodeType === Node.ELEMENT_NODE && e[o]) {
      let i = e[o];
      if (ae.isSingleTag(i) && !ae.isNativeInput(i) && !ae.isLineBreakTag(i))
        if (i[n])
          i = i[n];
  ...
  static isElement(e) {
    return vo(e) ? !1 : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return vo(e) ? !1 : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
  ...
  static getContentLength(e) {
    return ae.isNativeInput(e) ? e.value.length : e.nodeType === Node.TEXT_NODE ? e.length : e.textContent.length;
  }
  /**
  ...
  static containsOnlyInlineElements(e) {
    ...
    const o = (n) => !ae.blockElements.includes(n.tagName.toLowerCase()) && Array.from(n.children).every(o);
  ...
  static getDeepestBlockElements(e) {
    return ae.containsOnlyInlineElements(e) ? [e] : Array.from(e.children).reduce((t, o) => [...t, ...ae.getDeepestBlockElements(o)], []);
  }
  /**
...
class gt {
   ...
   */
  emit(e, t) {
    he(this.subscribers) || !this.subscribers[e] || this.subscribers[e].reduce((o, n) => {
      const i = n(o);
      return i !== void 0 ? i : o;
    }, t);
  }
...
let W = class Do {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    if (this.nodes = {}, this.listeners = new $t(), this.readOnlyMutableListeners = {
      /**
    ...
    }, this.mutableListenerIds = [], new.target === Do)
  ...
  static get isAtEditor() {
    return this.isSelectionAtEditor(Ce.get());
  }
  /**
  ...
  static isSelectionAtEditor(e) {
    ...
    let o = null;
    return t && t instanceof Element && (o = t.closest(`.${Ce.CSS.editorZone}`)), o ? o.nodeType === Node.ELEMENT_NODE : !1;
  }
  /**
   ...
   */
  save() {
    this.savedSelectionRange = Ce.range;
  }
  /**
...
const Ot = "redactor dom changed", jo = "block changed", Fo = "fake cursor is about to be toggled", Ho = "fake cursor have been set";
function xo(r, e) {
  return r.mergeable && r.name === e.name;
}
function ii(r, e) {
  const t = e == null ? void 0 : e.export;
  return Q(t) ? t(r) : Te(t) ? r[t] : (t !== void 0 && X("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function ri(r, e) {
...
let we = class Se extends gt {
  ...
  constructor({
    ...
    }, this.name = o.name, this.id = e, this.settings = o.settings, this.config = o.settings.config || {}, this.api = n, this.editorEventBus = a || null, this.blockAPI = new Be(this), this.tool = o, this.toolInstance = o.create(t, this.blockAPI, i), this.tunes = o.tunes, this.composeTunes(s), this.holder = this.compose(), window.requestIdleCallback(() => {
  ...
  set selected(e) {
    var t, o;
    this.holder.classList.toggle(Se.CSS.selected, e);
    const n = e === !0 && R.isRangeInsideContainer(this.holder), i = e === !1 && R.isFakeCursorInsideContainer(this.holder);
    (n || i) && ((t = this.editorEventBus) == null || t.emit(Fo, { state: e }), n ? R.addFakeCursor() : R.removeFakeCursor(this.holder), (o = this.editorEventBus) == null || o.emit(Ho, { state: e }));
  }
  /**
   ...
   */
  get selected() {
    return this.holder.classList.contains(Se.CSS.selected);
  }
  /**
   * Set stretched state
   *
   ...
   */
  set stretched(e) {
    this.holder.classList.toggle(Se.CSS.wrapperStretched, e);
  }
  /**
   ...
   */
  get stretched() {
    return this.holder.classList.contains(Se.CSS.wrapperStretched);
  }
  /**
   ...
   */
  set dropTarget(e) {
    this.holder.classList.toggle(Se.CSS.dropTarget, e);
  }
  /**
   ...
   */
  updateCurrentInput() {
    this.currentInput = y.isNativeInput(document.activeElement) || !R.anchorNode ? document.activeElement : R.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((o) => Object.entries(o.data).some(([n, i]) => t[n] && Jn(t[n], i)));
  }
  /**
  ...
  async exportDataAsString() {
    ...
    return ii(e, this.tool.conversionConfig);
  }
  /**
   ...
   */
  compose() {
    const e = y.make("div", Se.CSS.wrapper), t = y.make("div", Se.CSS.content), o = this.toolInstance.render();
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((n) => ni(n, this.toolRenderedElement)) && this.didMutated(o);
    }, (e = this.editorEventBus) == null || e.on(Ot, this.redactorDomChangedCallback);
  }
  /**
  ...
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null || e.off(Ot, this.redactorDomChangedCallback);
  }
  /**
...
class si extends W {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, n, i, s, a) => {
      ...
      return this.Editor.BlockManager.insertMany(o, t), o.map((n) => new Be(n));
    };
  }
  /**
   * Available methods
  ...
  getBlockIndex(e) {
    ...
    if (!t) {
      pe("There is no block with id `" + e + "`", "warn");
      return;
    }
  ...
  getBlockByIndex(e) {
    ...
    if (t === void 0) {
      pe("There is no block at index `" + e + "`", "warn");
      return;
    }
    return new Be(t);
  }
  ...
  getById(e) {
    const t = this.Editor.BlockManager.getBlockById(e);
    return t === void 0 ? (pe("There is no block with id `" + e + "`", "warn"), null) : new Be(t);
  }
  /**
...
class zt extends W {
  ...
  get methods() {
    return {
      t: () => {
        pe("I18n.t() method can be accessed only from Tools", "warn");
      }
    };
  }
  /**
        ...
        for (var O = 0; O < _.length; O++) {
          ...
          if (Y) {
            ...
            for (; D < H.parts.length; D++)
              Y.parts.push(E(H.parts[D], T));
          } else {
            var Z = [];
            for (D = 0; D < H.parts.length; D++)
              Z.push(E(H.parts[D], T));
            a[H.id] = { id: H.id, refs: 1, parts: Z };
          }
        }
      }
      function g(_, T) {
        for (var O = [], H = {}, Y = 0; Y < _.length; Y++) {
          var D = _[Y], Z = T.base ? D[0] + T.base : D[0], C = { css: D[1], media: D[2], sourceMap: D[3] };
          H[Z] ? H[Z].parts.push(C) : O.push(H[Z] = { id: Z, parts: [C] });
        }
        return O;
      }
      function f(_, T) {
        var O = l(_.insertInto);
        if (!O)
          throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");
        var H = p[p.length - 1];
        if (_.insertAt === "top")
          H ? H.nextSibling ? O.insertBefore(T, H.nextSibling) : O.appendChild(T) : O.insertBefore(T, O.firstChild), p.push(T);
...
`);
      ...
      function E(_, T) {
        ...
        if (T.singleton) {
          var Z = d++;
          O = u || (u = b(T)), H = V.bind(null, O, Z, !1), Y = V.bind(null, O, Z, !0);
        } else
          _.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (O = function(C) {
            var B = document.createElement("link");
            return C.attrs.type === void 0 && (C.attrs.type = "text/css"), C.attrs.rel = "stylesheet", w(B, C.attrs), f(C, B), B;
          }(T), H = (function(C, B, M) {
            var A = M.css, $ = M.sourceMap, j = B.convertToAbsoluteUrls === void 0 && $;
            (B.convertToAbsoluteUrls || j) && (A = k(A)), $ && (A += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify($)))) + " */");
            var ee = new Blob([A], { type: "text/css" }), G = C.href;
            C.href = URL.createObjectURL(ee), G && URL.revokeObjectURL(G);
          }).bind(null, O, T), Y = function() {
            v(O), O.href && URL.revokeObjectURL(O.href);
          }) : (O = b(T), H = (function(C, B) {
            var M = B.css, A = B.media;
            if (A && C.setAttribute("media", A), C.styleSheet)
              C.styleSheet.cssText = M;
            else {
              for (; C.firstChild; )
                C.removeChild(C.firstChild);
              C.appendChild(document.createTextNode(M));
            }
          }).bind(null, O), Y = function() {
            v(O);
          });
        return H(_), function(C) {
          if (C) {
            if (C.css === _.css && C.media === _.media && C.sourceMap === _.sourceMap)
              return;
            H(_ = C);
          } else
            Y();
      ...
      t.exports = function(_, T) {
        ...
        var O = g(_, T);
        return h(O, T), function(H) {
          for (var Y = [], D = 0; D < O.length; D++) {
            var Z = O[D];
            (C = a[Z.id]).refs--, Y.push(C);
          }
          for (H && h(g(H, T), T), D = 0; D < Y.length; D++) {
            var C;
            if ((C = Y[D]).refs === 0) {
...
`);
      ...
      t.exports = (i = "cdx-notifies", s = "cdx-notify", a = "cdx-notify__cross", c = "cdx-notify__button--confirm", l = "cdx-notify__button--cancel", u = "cdx-notify__input", d = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: k = function(h) {
        ...
        var g = k(h), f = document.createElement("div"), v = document.createElement("button"), b = document.createElement("button"), w = g.querySelector("." + a), E = h.cancelHandler, x = h.okHandler;
        return f.classList.add(p), v.innerHTML = h.okText || "Confirm", b.innerHTML = h.cancelText || "Cancel", v.classList.add(d), b.classList.add(d), v.classList.add(c), b.classList.add(l), E && typeof E == "function" && (b.addEventListener("click", E), w.addEventListener("click", E)), x && typeof x == "function" && v.addEventListener("click", x), v.addEventListener("click", g.remove.bind(g)), b.addEventListener("click", g.remove.bind(g)), f.appendChild(v), f.appendChild(b), g.appendChild(f), g;
      }, prompt: function(h) {
        var g = k(h), f = document.createElement("div"), v = document.createElement("button"), b = document.createElement("input"), w = g.querySelector("." + a), E = h.cancelHandler, x = h.okHandler;
        return f.classList.add(p), v.innerHTML = h.okText || "Ok", v.classList.add(d), v.classList.add(c), b.classList.add(u), h.placeholder && b.setAttribute("placeholder", h.placeholder), h.default && (b.value = h.default), h.inputType && (b.type = h.inputType), E && typeof E == "function" && w.addEventListener("click", E), x && typeof x == "function" && v.addEventListener("click", function() {
          x(b.value);
    ...
    t.prototype.clean = function(d) {
      ...
      if (h)
        do {
          ...
          var v = !!p.parentNode, b = n(p) && n(h) && v, w = h.nodeName.toLowerCase(), E = c(this.config, w, h), x = g && f;
          if (x || l(h, E) || !this.config.keepNestedBlockElements && b) {
          ...
          for (var I = 0; I < h.attributes.length; I += 1) {
            ...
            u(V, E, h) && (h.removeAttribute(V.name), I = I - 1);
          }
          this._sanitize(d, h);
...
function Uo(r, e) {
  return r.map((t) => {
    ...
    return he(o) || (t.data = qt(t.data, o)), t;
  });
}
function xe(r, e = {}) {
  const t = {
  ...
  return new vi(t).clean(r);
}
function qt(r, e) {
  return Array.isArray(r) ? ki(r, e) : re(r) ? yi(r, e) : Te(r) ? wi(r, e) : r;
}
function ki(r, e) {
  return r.map((t) => qt(t, e));
}
function yi(r, e) {
  const t = {};
  for (const o in r) {
    if (!Object.prototype.hasOwnProperty.call(r, o))
      continue;
    const n = r[o], i = xi(e[o]) ? e[o] : e;
    t[o] = qt(n, i);
  }
  return t;
}
function wi(r, e) {
  return re(e) ? xe(r, e) : e === !1 ? xe(r, {}) : r;
}
function xi(r) {
  return re(r) || zn(r) || Q(r);
}
class Ei extends W {
  /**
   * Available methods
...
class Ci extends W {
  ...
  save() {
    ...
    return this.Editor.ReadOnly.isEnabled ? (pe(e, "warn"), Promise.reject(new Error(e))) : this.Editor.Saver.save();
  }
}
class Si extends W {
  /**
...
class _i extends W {
  ...
  toggleBlockSettings(e) {
    if (this.Editor.BlockManager.currentBlockIndex === -1) {
      pe("Could't toggle the Toolbar because there is no block selected ", "warn");
      return;
    }
  ...
  toggleToolbox(e) {
    if (this.Editor.BlockManager.currentBlockIndex === -1) {
      pe("Could't toggle the Toolbox because there is no block selected ", "warn");
      return;
    }
...
const Li = /* @__PURE__ */ Ut(Nt);
let ge = null;
function Wt() {
  ge || (ge = new Li());
}
function Ii(r, e, t) {
  Wt(), ge == null || ge.show(r, e, t);
}
function Pt(r = !1) {
  Wt(), ge == null || ge.hide(r);
}
function tt(r, e, t) {
  Wt(), ge == null || ge.onHover(r, e, t);
}
function Mi() {
  ge == null || ge.destroy(), ge = null;
}
class Oi extends W {
  /**
   * @class
...
function $o(r, e) {
  ...
  return Object.entries(r).forEach(([o, n]) => {
    if (re(n)) {
      const i = e ? `${e}.${o}` : o;
      Object.values(n).every((s) => Te(s)) ? t[o] = i : t[o] = $o(n, i);
      return;
    }
    t[o] = n;
  }), t;
...
let Co = class ne {
  ...
  constructor(e) {
    this.nodes = {
      ...
      this.nodes.root.classList.remove(ne.CSS.noFocus);
    }, this.removeSpecialHoverBehavior = () => {
      this.nodes.root.classList.remove(ne.CSS.noHover);
    }, this.onErrorAnimationEnd = () => {
      this.nodes.icon.classList.remove(ne.CSS.wobbleAnimation), this.nodes.icon.removeEventListener("animationend", this.onErrorAnimationEnd);
   ...
   */
  get isFocused() {
    return this.nodes.root.classList.contains(ne.CSS.focused);
  }
  /**
   ...
   */
  toggleActive(e) {
    this.nodes.root.classList.toggle(ne.CSS.active, e);
  }
  /**
   ...
   */
  toggleHidden(e) {
    this.nodes.root.classList.toggle(ne.CSS.hidden, e);
  }
  /**
   ...
   */
  make(e) {
    const t = y.make("div", ne.CSS.container);
    return e.name && (t.dataset.itemName = e.name), this.nodes.icon = y.make("div", ne.CSS.icon, {
      innerHTML: e.icon || ji
    }), t.appendChild(this.nodes.icon), t.appendChild(y.make("div", ne.CSS.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && t.appendChild(y.make("div", ne.CSS.secondaryTitle, {
      textContent: e.secondaryLabel
    })), e.isActive && t.classList.add(ne.CSS.active), e.isDisabled && t.classList.add(ne.CSS.disabled), t;
  }
  /**
  ...
  enableConfirmationMode(e) {
    ...
    this.nodes.root.innerHTML = o.innerHTML, this.nodes.root.classList.add(ne.CSS.confirmationState), this.confirmationState = e, this.enableSpecialHoverAndFocusBehavior();
  }
  /**
  ...
  disableConfirmationMode() {
    ...
    this.nodes.root.innerHTML = e.innerHTML, this.nodes.root.classList.remove(ne.CSS.confirmationState), this.confirmationState = null, this.disableSpecialHoverAndFocusBehavior();
  }
  /**
  ...
  enableSpecialHoverAndFocusBehavior() {
    this.nodes.root.classList.add(ne.CSS.noHover), this.nodes.root.classList.add(ne.CSS.noFocus), this.nodes.root.addEventListener("mouseleave", this.removeSpecialHoverBehavior, { once: !0 });
  }
  /**
   ...
   */
  animateError() {
    this.nodes.icon.classList.contains(ne.CSS.wobbleAnimation) || (this.nodes.icon.classList.add(ne.CSS.wobbleAnimation), this.nodes.icon.addEventListener("animationend", this.onErrorAnimationEnd));
  }
};
const Ge = class {
  /**
  ...
  leafNodesAndReturnIndex(r) {
    if (this.items.length === 0)
      return this.cursor;
    let e = this.cursor;
    return e === -1 ? e = r === Ge.directions.RIGHT ? -1 : 0 : this.items[e].classList.remove(this.focusedCssClass), r === Ge.directions.RIGHT ? e = (e + 1) % this.items.length : e = (this.items.length + e - 1) % this.items.length, y.canSetCaret(this.items[e]) && ht(() => R.setCursor(this.items[e]), 50)(), this.items[e].classList.add(this.focusedCssClass), e;
  }
};
let De = Ge;
De.directions = {
  ...
  constructor(e) {
    this.iterator = null, this.activated = !1, this.flipCallbacks = [], this.onKeyDown = (t) => {
      if (this.isEventReadyForHandling(t))
        switch (Ee.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode) {
          case N.TAB:
    ...
    }, this.iterator = new De(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || Ee.usedKeys;
  }
  /**
...
class Je {
  ...
  constructor({ items: e, onSearch: t, placeholder: o }) {
    this.listeners = new $t(), this.items = e, this.onSearch = t, this.render(o);
  }
  /**
   ...
   */
  render(e) {
    this.wrapper = y.make("div", Je.CSS.wrapper);
    const t = y.make("div", Je.CSS.icon, {
      innerHTML: $i
    });
    this.input = y.make("input", Je.CSS.input, {
      placeholder: e,
      /**
...
const Ze = class {
   ...
   */
  lock() {
    wo ? this.lockHard() : document.body.classList.add(Ze.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    wo ? this.unlockHard() : document.body.classList.remove(Ze.CSS.scrollLocked);
  }
  /**
  ...
  lockHard() {
    ...
    ), document.body.classList.add(Ze.CSS.scrollLockedHard);
  }
  /**
   * Unlocks hard scroll lock
   */
  unlockHard() {
    document.body.classList.remove(Ze.CSS.scrollLockedHard), this.scrollPosition !== null && window.scrollTo(0, this.scrollPosition), this.scrollPosition = null;
  }
};
let qo = Ze;
qo.CSS = {
...
var Wi = Object.defineProperty, Vi = Object.getOwnPropertyDescriptor, Yi = (r, e, t, o) => {
  for (var n = o > 1 ? void 0 : o ? Vi(e, t) : e, i = r.length - 1, s; i >= 0; i--)
    (s = r[i]) && (n = (o ? s(e, t, n) : s(n)) || n);
  return o && n && Wi(e, t, n), n;
}, ot = /* @__PURE__ */ ((r) => (r.Close = "close", r))(ot || {});
const ie = class extends gt {
   ...
   */
  constructor(r) {
    super(), this.scopeElement = document.body, this.listeners = new $t(), this.scrollLocker = new qo(), this.nodes = {
      wrapper: null,
      popover: null,
    ...
    }, this.items = r.items.map((e) => new Co(e)), r.scopeElement !== void 0 && (this.scopeElement = r.scopeElement), r.messages && (this.messages = {
      ...this.messages,
      ...r.messages
  ...
  show() {
    ...
    }), Le() && this.scrollLocker.lock();
  }
  /**
   * Closes popover
   */
  hide() {
    this.nodes.popover.classList.remove(ie.CSS.popoverOpened), this.nodes.popover.classList.remove(ie.CSS.popoverOpenTop), this.nodes.overlay.classList.add(ie.CSS.overlayHidden), this.flipper.deactivate(), this.items.forEach((r) => r.reset()), this.search !== void 0 && this.search.clear(), Le() && this.scrollLocker.unlock(), this.emit(
      "close"
      /* Close */
    );
  }
   ...
   */
  destroy() {
    this.flipper.deactivate(), this.listeners.removeAll(), Le() && this.scrollLocker.unlock();
  }
  /**
  ...
  initializeFlipper() {
    this.flipper = new Ee({
      ...
      focusedItemClass: Co.CSS.focused,
      allowedKeys: [
        N.TAB,
        N.UP,
        N.DOWN,
...
class Ki extends W {
  ...
  open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.eventsDispatcher.emit(this.events.opened), this.popover = new Vt({
      searchable: !0,
      ...
      messages: {
        nothingFound: le.ui(fe.ui.popover, "Nothing found"),
        search: le.ui(fe.ui.popover, "Filter")
      }
    }), this.popover.on(ot.Close, this.onPopoverClose), this.nodes.wrapper.append(this.popover.getElement()), this.popover.show();
  }
  /**
...
class ce extends W {
  ...
  make() {
    this.nodes.wrapper = y.make("div", [
      ce.CSS.conversionToolbarWrapper,
      ...this.isRtl ? [this.Editor.UI.CSS.editorRtlFix] : []
    ]), this.nodes.tools = y.make("div", ce.CSS.conversionToolbarTools);
    const e = y.make("div", ce.CSS.conversionToolbarLabel, {
      textContent: le.ui(fe.ui.inlineToolbar.converter, "Convert to")
    });
   ...
   */
  open() {
    this.filterTools(), this.opened = !0, this.nodes.wrapper.classList.add(ce.CSS.conversionToolbarShowed), window.requestAnimationFrame(() => {
      this.flipper.activate(this.tools.map((e) => e.button).filter((e) => !e.classList.contains(ce.CSS.conversionToolHidden))), this.flipper.focusFirst(), Q(this.togglingCallback) && this.togglingCallback(!0);
    });
  }
  /**
   ...
   */
  close() {
    this.opened = !1, this.flipper.deactivate(), this.nodes.wrapper.classList.remove(ce.CSS.conversionToolbarShowed), Q(this.togglingCallback) && this.togglingCallback(!1);
  }
  /**
  ...
  addTool(e, t) {
    var o;
    const n = y.make("div", [ce.CSS.conversionTool]), i = y.make("div", [ce.CSS.conversionToolIcon]);
    n.dataset.tool = e, i.innerHTML = t.icon, y.append(n, i), y.append(n, y.text(le.t(fe.toolNames, t.title || qe(e))));
    const s = (o = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : o.shortcut;
    if (s) {
      const a = y.make("span", ce.CSS.conversionToolSecondaryLabel, {
        innerText: ft(s)
      });
      y.append(n, a);
    }
  ...
  async filterTools() {
    ...
    this.tools.forEach((n) => {
      ...
      n.button.hidden = i, n.button.classList.toggle(ce.CSS.conversionToolHidden, i);
    });
  }
  /**
  ...
  enableFlipper() {
    this.flipper = new Ee({
      focusedItemClass: ce.CSS.conversionToolFocused
    });
  }
}
var Dt = {}, Xi = {
...
const We = new Zi();
var Ji = Object.defineProperty, Qi = Object.getOwnPropertyDescriptor, Wo = (r, e, t, o) => {
  for (var n = o > 1 ? void 0 : o ? Qi(e, t) : e, i = r.length - 1, s; i >= 0; i--)
    (s = r[i]) && (n = (o ? s(e, t, n) : s(n)) || n);
  return o && n && Ji(e, t, n), n;
}, ct = /* @__PURE__ */ ((r) => (r.Opened = "toolbox-opened", r.Closed = "toolbox-closed", r.BlockAdded = "toolbox-block-added", r))(ct || {});
const Vo = class extends gt {
  /**
   * Toolbox constructor
   *
  ...
  make() {
    ...
    }), this.popover.on(ot.Close, this.onPopoverClose), this.enableShortcuts(), this.nodes.toolbox = this.popover.getElement(), this.nodes.toolbox.classList.add(Vo.CSS.toolbox), this.nodes.toolbox;
  }
  /**
  ...
  destroy() {
    var r;
    super.destroy(), this.nodes && this.nodes.toolbox && (this.nodes.toolbox.remove(), this.nodes.toolbox = null), this.removeAllShortcuts(), (r = this.popover) == null || r.off(ot.Close, this.onPopoverClose);
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    const r = (e, t) => ({
      icon: e.icon,
      title: le.t(fe.toolNames, e.title || qe(t.name)),
      name: t.name,
      onActivate: () => {
        this.toolButtonActivated(t.name, e.data);
      },
      secondaryLabel: t.shortcut ? ft(t.shortcut) : ""
    });
...
Wo([
  Ve
], Yt.prototype, "toolsToBeDisplayed", 1);
Wo([
  Ve
], Yt.prototype, "toolboxItemsToBeDisplayed", 1);
const Yo = "block hovered";
...
class tr extends W {
  ...
  async make() {
    ...
    const e = y.make("div");
    e.appendChild(document.createTextNode(le.ui(fe.ui.toolbar.toolbox, "Add"))), e.appendChild(y.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    })), tt(this.nodes.plusButton, e, {
      hidingDelay: 400
    }), this.nodes.settingsToggler = y.make("span", this.CSS.settingsToggler, {
      innerHTML: Hi
    }), y.append(this.nodes.actions, this.nodes.settingsToggler);
    const t = y.make("div"), o = y.text(le.ui(fe.ui.blockTunes.toggler, "Click to tune")), n = await er("Slash", "/");
    t.appendChild(o), t.appendChild(y.make("div", this.CSS.plusButtonShortcut, {
      textContent: ft(`CMD + ${n}`)
    })), tt(this.nodes.settingsToggler, t, {
      hidingDelay: 400
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new Yt({
      api: this.Editor.API.methods,
      tools: this.Editor.Tools.blockTools,
      i18nLabels: {
        filter: le.ui(fe.ui.popover, "Filter"),
        nothingFound: le.ui(fe.ui.popover, "Nothing found")
      }
  ...
  enableModuleBindings() {
    ...
    }, !0), Le() || this.eventsDispatcher.on(Yo, (e) => {
      var t;
...
var mt = /* @__PURE__ */ ((r) => (r[r.Block = 0] = "Block", r[r.Inline = 1] = "Inline", r[r.Tune = 2] = "Tune", r))(mt || {}), dt = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.Toolbox = "toolbox", r.EnabledInlineTools = "inlineToolbar", r.EnabledBlockTunes = "tunes", r.Config = "config", r))(dt || {}), Ko = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.SanitizeConfig = "sanitize", r))(Ko || {}), je = /* @__PURE__ */ ((r) => (r.IsEnabledLineBreaks = "enableLineBreaks", r.Toolbox = "toolbox", r.ConversionConfig = "conversionConfig", r.IsReadOnlySupported = "isReadOnlySupported", r.PasteConfig = "pasteConfig", r))(je || {}), Kt = /* @__PURE__ */ ((r) => (r.IsInline = "isInline", r.Title = "title", r))(Kt || {}), Xo = /* @__PURE__ */ ((r) => (r.IsTune = "isTune", r))(Xo || {});
class Xt {
  /**
   * @class
...
class or extends W {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }, this.opened = !1, this.toolbarVerticalMargin = Le() ? 20 : 6, this.buttonsList = null, this.width = 0, this.flipper = null;
  }
  /**
   * Toggles read-only mode
   *
  ...
  close() {
    this.opened && (this.Editor.ReadOnly.isEnabled || (this.nodes.wrapper.classList.remove(this.CSS.inlineToolbarShowed), Array.from(this.toolsInstances.entries()).forEach(([e, t]) => {
      ...
      o && We.remove(this.Editor.UI.nodes.redactor, o), Q(t.clear) && t.clear();
   ...
   */
  move() {
    const e = R.rect, t = this.Editor.UI.nodes.wrapper.getBoundingClientRect(), o = {
      x: e.x - t.x,
   ...
   */
  allowedToShow() {
    const e = ["IMG", "INPUT"], t = R.get(), o = R.text;
  ...
  addConversionToggler() {
    ...
    }), Le() === !1 && tt(this.nodes.conversionToggler, le.ui(fe.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
  ...
  async setConversionTogglerContent() {
    ...
    this.nodes.conversionTogglerContent.innerHTML = s.icon || s.title || qe(o);
  }
  /**
  ...
  async addToolsFiltered(e = !0) {
    const t = R.get(), o = this.Editor.BlockManager.getBlock(t.anchorNode);
  ...
  getToolShortcut(e) {
    ...
    return Array.from(n.keys()).includes(e) ? this.inlineTools[e][Ko.Shortcut] : o.shortcut;
  }
  /**
...
class nr extends W {
  ...
  beforeKeydownProcessing(e) {
    this.needToolbarClosing(e) && Oo(e.keyCode) && (this.Editor.Toolbar.close(), this.Editor.ConversionToolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || this.Editor.BlockSelection.clearSelection(e));
  }
  /**
   * Key up on Block:
  ...
  backspace(e) {
    ...
    if (!(!R.isCollapsed || !o.isAtStart)) {
      ...
      if (i !== null) {
        ...
        xo(n, i) ? this.mergeBlocks(i, n) : o.setToBlock(i, o.positions.END);
      }
    }
  }
  /**
  ...
  delete(e) {
    ...
    if (!(!R.isCollapsed || !o.isAtEnd)) {
      ...
      if (i !== null) {
        ...
        xo(n, i) ? this.mergeBlocks(n, i) : o.setToBlock(i, o.positions.START);
      }
    }
  }
  /**
   ...
   */
  arrowRightAndDown(e) {
    const t = Ee.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === N.TAB);
    if (this.Editor.UI.someToolbarOpened && t)
      return;
    this.Editor.Toolbar.close();
    const o = this.Editor.Caret.isAtEnd || this.Editor.BlockSelection.anyBlockSelected;
    if (e.shiftKey && e.keyCode === N.DOWN && o) {
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (Ee.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === N.TAB))
        return;
      this.Editor.UI.closeAllToolbars();
    }
    this.Editor.Toolbar.close();
    const t = this.Editor.Caret.isAtStart || this.Editor.BlockSelection.anyBlockSelected;
    if (e.shiftKey && e.keyCode === N.UP && t) {
  ...
  needToolbarClosing(e) {
    const t = e.keyCode === N.ENTER && this.Editor.Toolbar.toolbox.opened, o = e.keyCode === N.ENTER && this.Editor.BlockSettings.opened, n = e.keyCode === N.ENTER && this.Editor.InlineToolbar.opened, i = e.keyCode === N.ENTER && this.Editor.ConversionToolbar.opened, s = e.keyCode === N.TAB;
...
class Tt {
   ...
   */
  get nodes() {
    return Ao(this.workingArea.children);
  }
  /**
...
const So = "block-removed", To = "block-added", ir = "block-moved", _o = "block-changed";
class rr {
  constructor() {
...
class sr extends W {
  ...
  composeBlock({
    ...
    const i = this.Editor.ReadOnly.isEnabled, s = this.Editor.Tools.blockTools.get(e), a = new we({
      id: o,
      data: t,
      tool: s,
      api: this.Editor.API,
  ...
  insert({
    ...
    return s && this.blockDidMutated(So, this.getBlockByIndex(c), {
      index: c
    }), this._blocks.insert(c, l, s), this.blockDidMutated(To, l, {
      index: c
  ...
  async update(e, t) {
    ...
    return this._blocks.replace(i, n), this.blockDidMutated(_o, n, {
      index: i
    }), n;
  }
  /**
  ...
  insertDefaultBlockAtIndex(e, t = !1) {
    ...
    return this._blocks[e] = o, this.blockDidMutated(To, o, {
      index: e
  ...
  async mergeBlocks(e, t) {
    ...
    he(o) || await e.mergeWith(o), this.removeBlock(t), this.currentBlockIndex = this._blocks.indexOf(e);
  }
  /**
   * Remove passed Block
   *
  ...
  removeBlock(e, t = !0) {
    return new Promise((o) => {
      ...
      e.destroy(), this._blocks.remove(n), this.blockDidMutated(So, e, {
        index: n
  ...
  getBlock(e) {
    ...
    const t = this._blocks.nodes, o = e.closest(`.${we.CSS.wrapper}`), n = t.indexOf(o);
    if (n >= 0)
  ...
  setCurrentBlockByChildNode(e) {
    y.isElement(e) || (e = e.parentNode);
    const t = e.closest(`.${we.CSS.wrapper}`);
    if (!t)
      return;
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
      ...
      t.dragLeave(o);
    }), e.on("didMutated", (o) => this.blockDidMutated(_o, o, {
  ...
  blockDidMutated(e, t, o) {
    ...
    return this.eventsDispatcher.emit(jo, {
      event: n
    }), t;
  }
}
class ar extends W {
  ...
  clearSelection(e, t = !1) {
    ...
    const s = e && e instanceof KeyboardEvent, a = s && Oo(e.keyCode);
    if (this.anyBlockSelected && s && a && !R.isSelectionExists) {
      const c = o.removeSelectedBlocks();
      o.insertDefaultBlockAtIndex(c, !0), n.setToBlock(o.currentBlock), ht(() => {
        const l = e.key;
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((i) => {
      const s = xe(i.holder.innerHTML, this.sanitizerConfig), a = y.make("p");
...
class ut extends W {
  ...
  get isAtStart() {
    ...
    if (!e.focusable)
      return !0;
    const t = R.get(), o = y.getDeepestNode(e.currentInput);
    let n = t.focusNode;
   ...
   */
  set(e, t = 0) {
    const { top: o, bottom: n } = R.setCursor(e, t), { innerHeight: i } = window;
  ...
  createShadow(e) {
    ...
    t.classList.add(ut.CSS.shadowCaret), e.insertAdjacentElement("beforeend", t);
  }
  /**
   ...
   */
  restoreCaret(e) {
    const t = e.querySelector(`.${ut.CSS.shadowCaret}`);
    if (!t)
      return;
    new R().expandToTag(t);
    const o = document.createRange();
  ...
  insertContentAtCaretPosition(e) {
    const t = document.createDocumentFragment(), o = document.createElement("div"), n = R.get(), i = R.range;
...
class lr extends W {
    ...
    super(...arguments), this.onMouseUp = () => {
      ...
      if (!(!n || !i) && i !== n) {
        if (n === this.firstSelectedBlock) {
          R.get().removeAllRanges(), n.selected = !0, i.selected = !0, o.clearCache();
          return;
        }
  ...
  toggleBlockSelectedState(e = !0) {
    const { BlockManager: t, BlockSelection: o } = this.Editor;
    this.lastSelectedBlock || (this.lastSelectedBlock = this.firstSelectedBlock = t.currentBlock), this.firstSelectedBlock === this.lastSelectedBlock && (this.firstSelectedBlock.selected = !0, o.clearCache(), R.get().removeAllRanges());
...
class dr extends W {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }), this.eventsDispatcher.on(jo, (o) => {
      this.particularBlockChanged(o.event);
    }), this.eventsDispatcher.on(Fo, () => {
      this.disable();
    }), this.eventsDispatcher.on(Ho, () => {
      this.enable();
    });
  }
  /**
   ...
   */
  redactorChanged(e) {
    this.eventsDispatcher.emit(Ot, {
      mutations: e
    });
  }
}
const Go = class extends W {
  constructor() {
  ...
  async processDataTransfer(r, e = !1) {
    ...
    if ((o.includes ? o.includes("Files") : o.contains("Files")) && !he(this.toolsFiles)) {
    ...
    const a = Object.keys(this.toolsTags).reduce((u, d) => (u[d.toLowerCase()] = this.toolsTags[d].sanitizationConfig ?? {}, u), {}), c = Object.assign({}, a, t.getAllInlineToolsSanitizeConfig(), { br: {} }), l = xe(s, c);
   ...
   */
  collectTagNames(r) {
    return Te(r) ? [r] : re(r) ? Object.keys(r) : [];
  }
  /**
  ...
  getFilesConfig(r) {
    ...
    !t && !o || (t && !Array.isArray(t) && (X(`«extensions» property of the onDrop config for «${r.name}» Tool should be an array`), t = []), o && !Array.isArray(o) && (X(`«mimeTypes» property of the onDrop config for «${r.name}» Tool should be an array`), o = []), o && (o = o.filter((n) => Vn(n) ? !0 : (X(`MIME type value «${n}» for the «${r.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[r.name] = {
      extensions: t || [],
      mimeTypes: o || []
    });
  }
   ...
   */
  getPatternsConfig(r) {
    r.pasteConfig === !1 || !r.pasteConfig.patterns || he(r.pasteConfig.patterns) || Object.entries(r.pasteConfig.patterns).forEach(([e, t]) => {
   ...
   */
  async processFile(r) {
    const e = Wn(r), t = Object.entries(this.toolsFiles).find(([n, { mimeTypes: i, extensions: s }]) => {
  ...
  processHTML(r) {
    ...
    return t.innerHTML = r, this.getNodes(t).map((o) => {
      ...
      const { tags: a } = i.pasteConfig || { tags: [] }, c = a.reduce((d, p) => (this.collectTagNames(p).forEach((k) => {
        const h = re(p) ? p[k] : null;
        d[k.toLowerCase()] = h || {};
      }), d), {}), l = Object.assign({}, c, i.baseSanitizeConfig);
      if (n.tagName.toLowerCase() === "table") {
        const d = xe(n.outerHTML, l);
        n = y.make("div", void 0, {
          innerHTML: d
        }).firstChild;
      } else
        n.innerHTML = xe(n.innerHTML, l);
  ...
  async processInlinePaste(r) {
    ...
    if (e.currentBlock && e.currentBlock.tool.isDefault && o.textContent.length < Go.PATTERN_PROCESSING_MAX_LENGTH) {
...
let Zo = Go;
Zo.PATTERN_PROCESSING_MAX_LENGTH = 450;
class hr extends W {
  constructor() {
...
class Qe extends W {
  ...
  enableModuleBindings() {
    ...
    }, !1), this.listeners.on(document.body, "mousemove", Lt((t) => {
      this.processMouseMove(t);
    }, 10), {
      passive: !0
    }), this.listeners.on(document.body, "mouseleave", () => {
      this.processMouseLeave();
    }), this.listeners.on(window, "scroll", Lt((t) => {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = y.make("div", Qe.CSS.overlay, {}), n = y.make("div", Qe.CSS.overlayContainer, {}), i = y.make("div", Qe.CSS.rect, {});
  ...
  changingRectangle(e) {
    ...
    this.rectCrossesBlocks = !(i || s), this.isRectSelectionActivated || (this.rectCrossesBlocks = !1, this.isRectSelectionActivated = !0, this.shrinkRectangleToPoint(), this.overlayRectangle.style.display = "block"), this.updateRectangleSize(), this.Editor.Toolbar.close(), n !== void 0 && (this.trySelectNextBlock(n), this.inverseSelection(), R.get().removeAllRanges());
  }
  /**
  ...
  genInfoForMouseSelection() {
    ...
    const s = this.Editor.BlockManager.lastBlock.holder.querySelector("." + we.CSS.content), a = Number.parseInt(window.getComputedStyle(s).width, 10) / 2, c = e - a, l = e + a;
    return {
      index: i,
      leftPos: c,
      rightPos: l
    ...
    return new Promise((t) => {
      ...
      if (e.length === 0)
        ...
        const i = e.map(({ type: s, data: a, tunes: c, id: l }) => {
          o.available.has(s) === !1 && (pe(`Tool «${s}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(s, a, l), s = o.stubTool);
          let u;
          try {
            u = n.composeBlock({
              id: l,
...
class pr extends W {
  ...
  async save() {
    ...
    try {
      ...
      const i = await Promise.all(n), s = await Uo(i, (a) => t.blockTools.get(a).sanitizeConfig);
      return this.makeOutput(s);
    } catch (i) {
      pe("Saving failed due to the Error %o", "error", i);
    }
  }
  /**
   * Saves and validates
...
const fr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
/**
...
class Gt {
  ...
  constructor({ data: e, config: t, api: o, readOnly: n }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : Gt.DEFAULT_PLACEHOLDER, this._data = {}, this._element = null, this._preserveBlank = t.preserveBlank !== void 0 ? t.preserveBlank : !1, this.data = e;
  }
  /**
...
class Qt {
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = zi, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
      const t = e.getAttribute("href");
      this.nodes.input.value = t !== "null" ? t : "", this.selection.save();
    } else
      this.nodes.button.innerHTML = Eo, this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
    return !!e;
  }
  /**
...
class Jo {
   ...
   */
  make() {
    const e = y.make("div", this.CSS.wrapper), t = qi, o = y.make("div", this.CSS.info), n = y.make("div", this.CSS.title, {
...
Jo.isReadOnlySupported = !0;
class gr extends Xt {
  constructor() {
    super(...arguments), this.type = mt.Inline;
  }
  /**
...
class mr extends Xt {
  constructor() {
    super(...arguments), this.type = mt.Tune;
  }
  /**
...
var br = Object.defineProperty, vr = Object.getOwnPropertyDescriptor, Qo = (r, e, t, o) => {
  for (var n = o > 1 ? void 0 : o ? vr(e, t) : e, i = r.length - 1, s; i >= 0; i--)
    (s = r[i]) && (n = (o ? s(e, t, n) : s(n)) || n);
  return o && n && br(e, t, n), n;
};
class eo extends Xt {
  constructor() {
    super(...arguments), this.type = mt.Block, this.inlineTools = new be(), this.tunes = new be();
  }
  /**
  ...
  get sanitizeConfig() {
    ...
    for (const n in e)
      if (Object.prototype.hasOwnProperty.call(e, n)) {
        const i = e[n];
        re(i) ? o[n] = Object.assign({}, t, i) : o[n] = i;
      }
    return o;
  }
...
Qo([
  Ve
], eo.prototype, "sanitizeConfig", 1);
Qo([
  Ve
], eo.prototype, "baseSanitizeConfig", 1);
class kr {
  /**
   * @class
...
on.isTune = !0;
var yr = Object.defineProperty, wr = Object.getOwnPropertyDescriptor, xr = (r, e, t, o) => {
  for (var n = o > 1 ? void 0 : o ? wr(e, t) : e, i = r.length - 1, s; i >= 0; i--)
    (s = r[i]) && (n = (o ? s(e, t, n) : s(n)) || n);
  return o && n && yr(e, t, n), n;
};
class nn extends W {
  constructor() {
    super(...arguments), this.stubTool = "stub", this.toolsAvailable = new be(), this.toolsUnavailable = new be();
  }
  /**
  ...
  async prepare() {
    ...
    this.factory = new kr(e, this.config, this.Editor.API);
  ...
  assignInlineToolsToBlockTool(e) {
    if (this.config.inlineToolbar !== !1) {
      if (e.enabledInlineTools === !0) {
        e.inlineTools = new be(
          Array.isArray(this.config.inlineToolbar) ? this.config.inlineToolbar.map((t) => [t, this.inlineTools.get(t)]) : Array.from(this.inlineTools.entries())
        );
        return;
      }
      Array.isArray(e.enabledInlineTools) && (e.inlineTools = new be(
  ...
  assignBlockTunesToBlockTool(e) {
    if (e.enabledBlockTunes !== !1) {
      if (Array.isArray(e.enabledBlockTunes)) {
        ...
        e.tunes = new be([...t, ...this.blockTunes.internalTools]);
        return;
      }
...
class Cr extends W {
  ...
  get someFlipperButtonFocused() {
    return this.Editor.Toolbar.toolbox.hasFocus() ? !0 : Object.entries(this.Editor).filter(([e, t]) => t.flipper instanceof Ee).some(([e, t]) => t.flipper.hasFocus());
  }
  /**
   * Clean editor`s UI
   */
   ...
   */
  checkIsMobile() {
    this.isMobile = window.innerWidth < Ro;
  }
  /**
  ...
  loadStyles() {
    ...
    const t = y.make("style", null, {
      id: e,
      textContent: Er.toString()
    });
    this.config.style && !he(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), y.prepend(document.head, t);
  }
  /**
  ...
  watchBlockHoveredEvents() {
    let e;
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", Lt((t) => {
      const o = t.target.closest(".ce-block");
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(Yo, {
  ...
  backspacePressed(e) {
    ...
    if (o.anyBlockSelected && !R.isSelectionExists) {
  ...
  documentClicked(e) {
    ...
    if (!e.isTrusted)
      return;
    const n = e.target;
    this.nodes.holder.contains(n) || R.isAtEditor || (this.Editor.BlockManager.dropPointer(), this.Editor.Toolbar.close());
  ...
  redactorClicked(e) {
    ...
    if (y.isAnchor(t) && o) {
      ...
      const n = t.getAttribute("href"), i = Kn(n);
      Gn(i);
      return;
    }
   ...
   */
  selectionChanged() {
    const { CrossBlockSelection: e, BlockSelection: t } = this.Editor, o = R.anchorElement;
    if (e.isCrossBlockSelectionStarted && t.anyBlockSelected && R.get().removeAllRanges(), !o) {
      R.range || this.Editor.InlineToolbar.close();
      return;
    }
    const n = o.closest(`.${we.CSS.content}`) === null;
...
const Sr = {
  ...
  BlockSelection: ar,
  Caret: ut,
  CrossBlockSelection: lr,
  DragNDrop: cr,
  ModificationsObserver: dr,
  Paste: Zo,
  ReadOnly: hr,
  RectangleSelection: Qe,
  Renderer: ur,
  Saver: pr,
  Tools: nn,
  UI: Cr
...
class Tr {
   ...
   */
  constructor(e) {
    this.moduleInstances = {}, this.eventsDispatcher = new gt();
    let t, o;
  ...
  set configuration(e) {
    ...
    re(e) ? this.config = {
      ...
      holder: e
    }, Mt(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = Mo.VERBOSE), $n(this.config.logLevel), Mt(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const n = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (he(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [n] }), this.config.readOnly = this.config.readOnly || !1, (t = this.config.i18n) != null && t.messages && le.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((o = this.config.i18n) == null ? void 0 : o.direction) || "ltr";
  }
  /**
...
.ce-block--drop-target .ce-block__content:after {
          ...
          for (var M = 0; M < C.length; M++) {
            ...
            if ($) {
              ...
              for (var j = 0; j < $.parts.length; j++)
                $.parts[j](A.parts[j]);
              for (; j < A.parts.length; j++)
                $.parts.push(T(A.parts[j], B));
            } else {
              var ee = [];
              for (j = 0; j < A.parts.length; j++)
                ee.push(T(A.parts[j], B));
              d[A.id] = { id: A.id, refs: 1, parts: ee };
            }
          }
        }
        function E(C, B) {
          for (var M = [], A = {}, $ = 0; $ < C.length; $++) {
            var j = C[$], ee = B.base ? j[0] + B.base : j[0], G = { css: j[1], media: j[2], sourceMap: j[3] };
            A[ee] ? A[ee].parts.push(G) : M.push(A[ee] = { id: ee, parts: [G] });
          }
          return M;
        }
        function x(C, B) {
          var M = h(C.insertInto);
          if (!M)
            throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");
          var A = v[v.length - 1];
          if (C.insertAt === "top")
            A ? A.nextSibling ? M.insertBefore(B, A.nextSibling) : M.appendChild(B) : M.insertBefore(B, M.firstChild), v.push(B);
 ...
 (https://github.com/webpack-contrib/style-loader#insertat)
`);
            var $ = h(C.insertInto + " " + C.insertAt.before);
            M.insertBefore(B, $);
          }
        }
        function I(C) {
        ...
        function V(C) {
          ...
          return C.attrs.type === void 0 && (C.attrs.type = "text/css"), _(B, C.attrs), x(C, B), B;
        }
        function _(C, B) {
          Object.keys(B).forEach(function(M) {
            C.setAttribute(M, B[M]);
          });
        }
        function T(C, B) {
          var M, A, $, j;
          if (B.transform && C.css) {
            if (!(j = B.transform(C.css)))
              return function() {
              };
            C.css = j;
          }
          if (B.singleton) {
            var ee = f++;
            M = g || (g = V(B)), A = Y.bind(null, M, ee, !1), $ = Y.bind(null, M, ee, !0);
          } else
            C.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (M = function(G) {
              var me = document.createElement("link");
              return G.attrs.type === void 0 && (G.attrs.type = "text/css"), G.attrs.rel = "stylesheet", _(me, G.attrs), x(G, me), me;
            }(B), A = Z.bind(null, M, B), $ = function() {
              I(M), M.href && URL.revokeObjectURL(M.href);
            }) : (M = V(B), A = D.bind(null, M), $ = function() {
              I(M);
            });
          return A(C), function(G) {
            if (G) {
        ...
        s.exports = function(C, B) {
          ...
          var M = E(C, B);
          return w(M, B), function(A) {
            for (var $ = [], j = 0; j < M.length; j++) {
              var ee = M[j];
              (G = d[ee.id]).refs--, $.push(G);
            }
            for (A && w(E(A, B), B), j = 0; j < $.length; j++) {
              var G;
              if ((G = $[j]).refs === 0) {
                for (var me = 0; me < G.parts.length; me++)
                  G.parts[me]();
                delete d[G.id];
              }
            }
        ...
        var O, H = (O = [], function(C, B) {
          return O[C] = B, O.filter(Boolean).join(`
`);
        });
        function Y(C, B, M, A) {
          var $ = M ? "" : A.css;
          if (C.styleSheet)
            C.styleSheet.cssText = H(B, $);
          else {
            var j = document.createTextNode($), ee = C.childNodes;
            ee[B] && C.removeChild(ee[B]), ee.length ? C.insertBefore(j, ee[B]) : C.appendChild(j);
          }
        }
        function D(C, B) {
          var M = B.css, A = B.media;
        ...
        function Z(C, B, M) {
          var A = M.css, $ = M.sourceMap, j = B.convertToAbsoluteUrls === void 0 && $;
          (B.convertToAbsoluteUrls || j) && (A = b(A)), $ && (A += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify($)))) + " */");
          var ee = new Blob([A], { type: "text/css" }), G = C.href;
          C.href = URL.createObjectURL(ee), G && URL.revokeObjectURL(G);
        }
...
const Mr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M19 17V10.2135C19 10.1287 18.9011 10.0824 18.836 10.1367L16 12.5"/></svg>', Or = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 11C16 10 19 9.5 19 12C19 13.9771 16.0684 13.9997 16.0012 16.8981C15.9999 16.9533 16.0448 17 16.1 17L19.3 17"/></svg>', Ar = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 11C16 10.5 16.8323 10 17.6 10C18.3677 10 19.5 10.311 19.5 11.5C19.5 12.5315 18.7474 12.9022 18.548 12.9823C18.5378 12.9864 18.5395 13.0047 18.5503 13.0063C18.8115 13.0456 20 13.3065 20 14.8C20 16 19.5 17 17.8 17C17.8 17 16 17 16 16.3"/></svg>', Rr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M18 10L15.2834 14.8511C15.246 14.9178 15.294 15 15.3704 15C16.8489 15 18.7561 15 20.2 15M19 17C19 15.7187 19 14.8813 19 13.6"/></svg>', Nr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 15.9C16 15.9 16.3768 17 17.8 17C19.5 17 20 15.6199 20 14.7C20 12.7323 17.6745 12.0486 16.1635 12.9894C16.094 13.0327 16 12.9846 16 12.9027V10.1C16 10.0448 16.0448 10 16.1 10H19.8"/></svg>', Pr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M19.5 10C16.5 10.5 16 13.3285 16 15M16 15V15C16 16.1046 16.8954 17 18 17H18.3246C19.3251 17 20.3191 16.3492 20.2522 15.3509C20.0612 12.4958 16 12.6611 16 15Z"/></svg>', Dr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 7L9 12M9 17V12M9 12L15 12M15 7V12M15 17L15 12"/></svg>';
/**
...
(function(r) {
  ...
  typeof ze < "u" ? ze : typeof window < "u" ? window : typeof self < "u" ? self : ze
);
(function(r) {
  var e = function() {
    try {
    ...
    var n = r.URL, i = function(c, l) {
      ...
      ["append", "delete", "set"].forEach(function(w) {
        var E = h[w];
        h[w] = function() {
          E.apply(h, arguments), g && (f = !1, v.search = h.toString(), f = !0);
        };
          ...
          try {
            ...
            if (v && (typeof v == "object" || typeof v == "function")) {
              ...
              if (typeof b == "function")
                return void g((w = b, E = v, function() {
                  w.apply(E, arguments);
                }), f);
            }
              ...
              try {
                if (_ && (typeof _ == "object" || typeof _ == "function")) {
                  ...
                  if (typeof T == "function")
                    return void T.call(_, function(O) {
                      x(V, O);
                    }, b);
                }
                w[V] = _, --E == 0 && v(w);
      ...
      var s, a, c, l, u, d, p = n(8), k = (a = function(h) {
        return new Promise(function(g, f) {
          ...
          v.open(h.method, h.url), v.setRequestHeader("X-Requested-With", "XMLHttpRequest"), Object.keys(h.headers).forEach(function(w) {
            var E = h.headers[w];
            v.setRequestHeader(w, E);
          });
          var b = h.ratio;
          v.upload.addEventListener("progress", function(w) {
            var E = Math.round(w.loaded / w.total * 100), x = Math.ceil(E * b / 100);
            h.progress(x);
          }, !1), v.addEventListener("progress", function(w) {
            var E = Math.round(w.loaded / w.total * 100), x = Math.ceil(E * (100 - b) / 100) + b;
            h.progress(x);
            ...
            if (v.readyState === 4) {
              ...
              var E = p.parseHeaders(v.getAllResponseHeaders()), x = { body: w, code: v.status, headers: E };
        ...
        (function(a, c) {
          if (!a.setImmediate) {
            ...
            b = b && b.setTimeout ? b : a, {}.toString.call(a.process) === "[object process]" ? l = function(x) {
              ...
              x.source === a && typeof x.data == "string" && x.data.indexOf(p) === 0 && E(+x.data.slice(p.length));
              ...
              I.onreadystatechange = function() {
                E(x), I.onreadystatechange = null, u.removeChild(I), I = null;
              }, u.appendChild(I);
            }) : l = function(x) {
              setTimeout(E, 0, x);
...
let Ae = class jt {
  ...
  static isAtStart() {
    ...
    if (e.focusOffset > 0)
      return !1;
    const t = e.focusNode;
    return jt.getHigherLevelSiblings(t, "left").every((o) => an(o));
  }
  /**
...
const qr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><line x1="9" x2="19" y1="7" y2="7" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="9" x2="19" y1="12" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="9" x2="19" y1="17" y2="17" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 17H4.99002"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 12H4.99002"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 7H4.99002"/></svg>', Lo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><line x1="12" x2="19" y1="7" y2="7" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="12" x2="19" y1="12" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="12" x2="19" y1="17" y2="17" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.79999 14L7.79999 7.2135C7.79999 7.12872 7.7011 7.0824 7.63597 7.13668L4.79999 9.5"/></svg>';
let Wr = class Ft {
  /**
  ...
  constructor({ data: e, config: t, api: o, readOnly: n }) {
    ...
    this.data = e && Object.keys(e).length ? e : i, this.caret = new Ae();
  }
  /**
   ...
   */
  createItem(e, t = []) {
    const o = Ue("li", this.CSS.item), n = Ue("div", this.CSS.itemBody), i = Ue("div", this.CSS.itemContent, {
      innerHTML: e,
      contentEditable: !this.readOnly
    });
  ...
  makeListWrapper(e = this.listStyle, t = []) {
    ...
    return t.push(n), Ue(o, [this.CSS.wrapper, ...t]);
  }
  /**
   * Styles
   *
  ...
  enterPressed(e) {
    ...
    const s = Ae.extractFragmentFromCaretPositionTillTheEnd(), a = Bo(s), c = t.querySelector(`.${this.CSS.itemChildren}`), l = this.createItem(a, void 0);
  ...
  backspace(e) {
    ...
    if (o) {
      ...
      i = n;
    const s = Ae.extractFragmentFromCaretPositionTillTheEnd(), a = Bo(s), c = i.querySelector(`.${this.CSS.itemContent}`);
  ...
  static joinRecursive(e) {
    return e.items.map((t) => `${t.content} ${Ft.joinRecursive(t)}`).join("");
  }
  /**
...
var Vr = Object.defineProperty, Yr = (r, e, t) => e in r ? Vr(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t, Kr = (r, e, t) => (Yr(r, typeof e != "symbol" ? e + "" : e, t), t);
const Xr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 8L5 12L9 16"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 8L19 12L15 16"/></svg>';
function Gr(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
function Ht(r, e, t) {
...
Ht.debounce = Ht;
var Zr = Ht;
const Jr = /* @__PURE__ */ Gr(Zr), ln = class He {
  ...
  makeEmbed() {
    var e, t;
    if (this.showProgress(), !this.data || !He.services)
      return null;
    const { html: o } = He.services[this.data.service], n = this.make("div", this.CSS.baseClass), i = this.make("div", this.CSS.container), s = document.createElement("template");
  ...
  async embedIsReady(e) {
    let t = null;
    return new Promise((o) => {
      t = new MutationObserver(Jr(o, 450)), t.observe(e, {
        childList: !0,
        subtree: !0
      });
    }).then(() => {
  ...
  setData(e) {
    ...
    if (!He.services)
      return;
    const n = (t = Object.entries(He.services).find(([, p]) => p.regex.test(e))) == null ? void 0 : t[1];
    if (!n)
      return;
  ...
  static prepare({ config: e = {} }) {
    ...
    if (!t)
      return;
    let o = Object.entries(es);
    const n = Object.entries(t).filter(([, i]) => typeof i == "boolean" && i === !0).map(([i]) => i);
    n.length && (o = o.filter(([i]) => n.includes(i))), He.services = o.reduce((i, [s, a]) => s in i ? (i[s] = Object.assign({}, i[s], a), i) : (i[s] = a, i), {});
  }
...
const ts = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19V19C9.13623 19 8.20435 19 7.46927 18.6955C6.48915 18.2895 5.71046 17.5108 5.30448 16.5307C5 15.7956 5 14.8638 5 13V12C5 9.19108 5 7.78661 5.67412 6.77772C5.96596 6.34096 6.34096 5.96596 6.77772 5.67412C7.78661 5 9.19108 5 12 5H13.5C14.8956 5 15.5933 5 16.1611 5.17224C17.4395 5.56004 18.44 6.56046 18.8278 7.83886C19 8.40666 19 9.10444 19 10.5V10.5"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 13V16M16 19V16M19 16H16M16 16H13"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.5 17.5L17.5 6.5"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.9919 10.5H19.0015"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.9919 19H11.0015"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13L13 5"/></svg>', os = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.9919 9.5H19.0015"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.5 5H14.5096"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.625 5H15C17.2091 5 19 6.79086 19 9V9.375"/><path stroke="currentColor" stroke-width="2" d="M9.375 5L9 5C6.79086 5 5 6.79086 5 9V9.375"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.3725 5H9.38207"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 9.5H5.00957"/><path stroke="currentColor" stroke-width="2" d="M9.375 19H9C6.79086 19 5 17.2091 5 15V14.625"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.3725 19H9.38207"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 14.55H5.00957"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 13V16M16 19V16M19 16H16M16 16H13"/></svg>', cn = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.13968 15.32L8.69058 11.5661C9.02934 11.2036 9.48873 11 9.96774 11C10.4467 11 10.9061 11.2036 11.2449 11.5661L15.3871 16M13.5806 14.0664L15.0132 12.533C15.3519 12.1705 15.8113 11.9668 16.2903 11.9668C16.7693 11.9668 17.2287 12.1705 17.5675 12.533L18.841 13.9634"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.7778 9.33331H13.7867"/></svg>', ns = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9L20 12L17 15"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 12H20"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 9L4 12L7 15"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12H10"/></svg>';
function Re(r, e = null, t = {}) {
  const o = document.createElement(r);
  Array.isArray(e) ? o.classList.add(...e) : e && o.classList.add(e);
  for (const n in t)
    o[n] = t[n];
...
class ue {
  ...
  constructor({ api: e, config: t, onSelectFile: o, readOnly: n }) {
    this.api = e, this.config = t, this.onSelectFile = o, this.readOnly = n, this.nodes = {
      wrapper: Re("div", [this.CSS.baseClass, this.CSS.wrapper]),
      imageContainer: Re("div", [this.CSS.imageContainer]),
      fileButton: this.createFileButton(),
      imageEl: void 0,
      imagePreloader: Re("div", this.CSS.imagePreloader),
      caption: Re("div", [this.CSS.input, this.CSS.caption], {
        contentEditable: !this.readOnly
      })
   ...
   */
  render(e) {
    return !e.file || Object.keys(e.file).length === 0 ? this.toggleStatus(ue.status.EMPTY) : this.toggleStatus(ue.status.UPLOADING), this.nodes.wrapper;
  }
  /**
   ...
   */
  createFileButton() {
    const e = Re("div", [this.CSS.button]);
    return e.innerHTML = this.config.buttonContent || `${cn} ${this.api.i18n.t("Select an Image")}`, e.addEventListener("click", () => {
      this.onSelectFile();
    }), e;
  }
  /**
   ...
   */
  showPreloader(e) {
    this.nodes.imagePreloader.style.backgroundImage = `url(${e})`, this.toggleStatus(ue.status.UPLOADING);
  }
  /**
   ...
   */
  hidePreloader() {
    this.nodes.imagePreloader.style.backgroundImage = "", this.toggleStatus(ue.status.EMPTY);
  }
  /**
   * Shows an image
   *
  ...
  fillImage(e) {
    ...
    let n = "load";
    t === "VIDEO" && (o.autoplay = !0, o.loop = !0, o.muted = !0, o.playsinline = !0, n = "loadeddata"), this.nodes.imageEl = Re(t, this.CSS.imageEl, o), this.nodes.imageEl.addEventListener(n, () => {
      this.toggleStatus(ue.status.FILLED), this.nodes.imagePreloader && (this.nodes.imagePreloader.style.backgroundImage = "");
   ...
   */
  toggleStatus(e) {
    for (const t in ue.status)
      Object.prototype.hasOwnProperty.call(ue.status, t) && this.nodes.wrapper.classList.toggle(`${this.CSS.wrapper}--${ue.status[t]}`, e === ue.status[t]);
  }
  /**
    ...
    return function(t) {
      ...
      var s, a, c, l, u, d, p, k = n(8), h = (a = function(g) {
        return new Promise(function(f, v) {
          ...
          b.open(g.method, g.url), b.setRequestHeader("X-Requested-With", "XMLHttpRequest"), Object.keys(g.headers).forEach(function(E) {
            var x = g.headers[E];
            b.setRequestHeader(E, x);
          });
          var w = g.ratio;
          b.upload.addEventListener("progress", function(E) {
            var x = Math.round(E.loaded / E.total * 100), I = Math.ceil(x * w / 100);
            g.progress(Math.min(I, 100));
          }, !1), b.addEventListener("progress", function(E) {
            var x = Math.round(E.loaded / E.total * 100), I = Math.ceil(x * (100 - w) / 100) + w;
            g.progress(Math.min(I, 100));
            ...
            if (b.readyState === 4) {
              ...
              var x = k.parseHeaders(b.getAllResponseHeaders()), I = { body: E, code: b.status, headers: x };
              p(b.status) ? f(I) : v(I);
            }
          }, b.send(g.data);
        });
        ...
        return g = l(g), k.selectFiles(g).then(function(f) {
          ...
          k.isObject(g.data) && Object.keys(g.data).forEach(function(E) {
            var x = g.data[E];
            v.append(E, x);
          });
          var w = g.beforeSend;
...
class ss {
  ...
  uploadSelectedFile({ onPreview: e }) {
    ...
    let o;
    this.config.uploader && typeof this.config.uploader.uploadByFile == "function" ? o = _e.selectFiles({ accept: this.config.types }).then((n) => t(n[0]).then(() => {
      const i = this.config.uploader.uploadByFile(n[0]);
      return _t(i) || console.warn("Custom uploader method uploadByFile should return a Promise"), i;
    })) : o = _e.selectFiles({ accept: this.config.types }).then((n) => t(n[0]).then(() => _e.transport({
  ...
  uploadByUrl(e) {
    let t;
    this.config.uploader && typeof this.config.uploader.uploadByUrl == "function" ? (t = this.config.uploader.uploadByUrl(e), _t(t) || console.warn("Custom uploader method uploadByUrl should return a Promise")) : t = _e.post({
      url: this.config.endpoints.byUrl,
      data: Object.assign({
        url: e
      }, this.config.additionalRequestData),
      type: _e.contentType.JSON,
      headers: this.config.additionalRequestHeaders
  ...
  uploadByFile(e, { onPreview: t }) {
    ...
    if (this.config.uploader && typeof this.config.uploader.uploadByFile == "function")
      n = this.config.uploader.uploadByFile(e), _t(n) || console.warn("Custom uploader method uploadByFile should return a Promise");
    else {
...
class pt {
   ...
   */
  renderSettings() {
    return pt.tunes.concat(this.config.actions).map((e) => ({
      icon: e.icon,
   ...
   */
  set data(e) {
    this.image = e.file, this._data.caption = e.caption || "", this.ui.fillCaption(this._data.caption), pt.tunes.forEach(({ name: t }) => {
...
const as = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M18 7L6 7"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M18 17H6"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 12L8 12"/></svg>', ls = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17 7L5 7"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17 17H5"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13 12L5 12"/></svg>', cs = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 10.8182L9 10.8182C8.80222 10.8182 8.60888 10.7649 8.44443 10.665C8.27998 10.5651 8.15181 10.4231 8.07612 10.257C8.00043 10.0909 7.98063 9.90808 8.01922 9.73174C8.0578 9.55539 8.15304 9.39341 8.29289 9.26627C8.43275 9.13913 8.61093 9.05255 8.80491 9.01747C8.99889 8.98239 9.19996 9.00039 9.38268 9.0692C9.56541 9.13801 9.72159 9.25453 9.83147 9.40403C9.94135 9.55353 10 9.72929 10 9.90909L10 12.1818C10 12.664 9.78929 13.1265 9.41421 13.4675C9.03914 13.8084 8.53043 14 8 14"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 10.8182L15 10.8182C14.8022 10.8182 14.6089 10.7649 14.4444 10.665C14.28 10.5651 14.1518 10.4231 14.0761 10.257C14.0004 10.0909 13.9806 9.90808 14.0192 9.73174C14.0578 9.55539 14.153 9.39341 14.2929 9.26627C14.4327 9.13913 14.6109 9.05255 14.8049 9.01747C14.9989 8.98239 15.2 9.00039 15.3827 9.0692C15.5654 9.13801 15.7216 9.25453 15.8315 9.40403C15.9414 9.55353 16 9.72929 16 9.90909L16 12.1818C16 12.664 15.7893 13.1265 15.4142 13.4675C15.0391 13.8084 14.5304 14 14 14"/></svg>';
class $e {
  /**
   * Notify core that read-only mode is supported
   *
   ...
   */
  constructor({ data: e, config: t, api: o, readOnly: n }) {
    const { ALIGNMENTS: i, DEFAULT_ALIGNMENT: s } = $e;
    this.api = o, this.readOnly = n, this.quotePlaceholder = t.quotePlaceholder || $e.DEFAULT_QUOTE_PLACEHOLDER, this.captionPlaceholder = t.captionPlaceholder || $e.DEFAULT_CAPTION_PLACEHOLDER, this.data = {
      text: e.text || "",
      caption: e.caption || "",
...
class hs {
  ...
  render() {
    var t, o, n, i, s, a;
    const e = document.createElement("div");
    return e.innerText = ds, e.style.fontWeight = ((t = Ne.fontWeight) == null ? void 0 : t.toString()) ?? "", e.style.backgroundColor = ((o = Ne.backgroundColor) == null ? void 0 : o.toString()) ?? "", e.style.paddingTop = ((n = Ne.paddingTop) == null ? void 0 : n.toString()) ?? "", e.style.paddingBottom = ((i = Ne.paddingBottom) == null ? void 0 : i.toString()) ?? "", e.style.width = ((s = Ne.width) == null ? void 0 : s.toString()) ?? "", e.style.textAlign = ((a = Ne.textAlign) == null ? void 0 : a.toString()) ?? "", e;
  }
  save() {
    return {};
  }
...
const us = {
  ...
  header: us,
  link: ms(r == null ? void 0 : r.link),
  list: ps,
  embed: fs,
  image: bs(r == null ? void 0 : r.image),
  quote: gs,
  payment: vs
}), ys = ({ id: r, data: e, onChange: t, config: o }) => {
  ...
  return /* @__PURE__ */ q.jsx("div", { id: r, className: "w-full" });
}, js = et.memo(ys);
var hn = { exports: {} };
/*!
...
var ws = hn.exports;
const ve = /* @__PURE__ */ Io(ws), xs = "_payment_8gufy_89", F = {
  ...
  if (e)
    return /* @__PURE__ */ q.jsx("div", { children: /* @__PURE__ */ q.jsx("div", { id: r, className: ve(e.withBackground && "bg-[#cdd1e0] p-[15px]"), children: /* @__PURE__ */ q.jsx(
      "img",
      {
        src: e.file.url,
  ...
  return /* @__PURE__ */ q.jsx("div", { className: F["cdx-block"], children: /* @__PURE__ */ q.jsx("div", { id: r, className: F["link-tool"], children: /* @__PURE__ */ q.jsxs(
    "a",
    {
      className: ve(
      ...
      children: [
        ...
        /* @__PURE__ */ q.jsx("div", { className: F["link-tool__title"], children: e.meta.title }),
        /* @__PURE__ */ q.jsx("p", { className: F["link-tool__description"], children: e.meta.description }),
        /* @__PURE__ */ q.jsx("span", { className: F["link-tool__anchor"], children: t })
      ]
    }
  ) }) });
}, Ts = ({ id: r, data: e }) => {
  if (e)
    return e.level === 2 ? /* @__PURE__ */ q.jsx(
      "h2",
      {
        id: r,
  ...
  if (!e)
    return;
  const t = e.style, o = t === "ordered" ? "cdx-nested-list--ordered" : "cdx-nested-list--unordered", n = (i) => i.map((s, a) => /* @__PURE__ */ q.jsx("li", { className: F["cdx-nested-list__item"], children: /* @__PURE__ */ q.jsxs("div", { className: F["cdx-nested-list__item-body"], children: [
    /* @__PURE__ */ q.jsx(
      "div",
      {
    ...
    s.items.length !== 0 && t === "ordered" && /* @__PURE__ */ q.jsx(
      "ol",
      {
        className: ve(
          F["cdx-nested-list"],
    ...
    s.items.length !== 0 && t === "unordered" && /* @__PURE__ */ q.jsx(
      "ul",
      {
        className: ve(
          F["cdx-nested-list"],
  ...
  return e.style === "ordered" ? /* @__PURE__ */ q.jsx(
    "ol",
    {
      id: r,
      className: ve(
  ...
  if (e)
    return /* @__PURE__ */ q.jsx("div", { className: F["cdx-block"], children: /* @__PURE__ */ q.jsx("div", { id: r, className: F["embed-tool"], children: /* @__PURE__ */ q.jsx(
      "iframe",
      {
        frameBorder: "0",
        src: e.embed,
  ...
  return /* @__PURE__ */ q.jsx("blockquote", { id: r, className: ve(F["cdx-block"], F["cdx-quote"]), children: /* @__PURE__ */ q.jsxs(
    "div",
    {
...
}, Is = ({ id: r }) => /* @__PURE__ */ q.jsx("div", { id: r, className: F.payment, children: "このラインより先を有料にする" }), Ms = (r = {}) => {
  const e = Object.assign({}, r), t = (n) => n.map(o), o = (n, i) => {
    if (e[n.type])
      return /* @__PURE__ */ q.jsx("div", { className: F["ce-block"], children: /* @__PURE__ */ q.jsx("div", { className: F["cdx-block"], children: e[n.type](n) }) }, i);
    throw new Os(n.type);
  };
  return {
    parse: t
...
const As = Ms({
  ...
  const e = As.parse(r);
  return /* @__PURE__ */ q.jsx("div", { className: "w-full", children: e });
}, Fs = Rs;
export {
  Fs as Preview,
  js as default
